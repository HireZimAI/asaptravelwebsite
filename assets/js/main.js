(function () {
  ...
  var CARS = [
    ...
    { id: 'fit', name: 'Honda Fit', cat: 'Individual', tabs: ['city'], price: '$40', seats: 5, trans: 'Automatic', drive: 'City', badge: 'Best value', gradient: 'linear-gradient(135deg,#2A2828,#4A4746)', img: 'assets/images/vehicles/honda-fit.jpg', alt: 'Blue Honda Fit hatchback parked outdoors' },
    { id: 'aqua', name: 'Toyota Aqua Hybrid', cat: 'Individual', tabs: ['city'], price: '$45', seats: 5, trans: 'Automatic', drive: 'Hybrid', badge: 'Fuel saver', gradient: 'linear-gradient(135deg,#233A2E,#3E5E48)', img: 'assets/images/vehicles/toyota-aqua.jpg', alt: 'Light blue Toyota Aqua hybrid on a city street' },
    ...
    { id: 'starex', name: 'Hyundai Grand Starex', cat: 'Group', tabs: ['group'], price: '$110', seats: 11, trans: 'Automatic', drive: 'Groups', badge: 'Family trips', gradient: 'linear-gradient(135deg,#2A2828,#4A4746)', img: 'assets/images/vehicles/hyundai-grand-starex.jpg', alt: 'Silver Hyundai Grand Starex van' },
    ...
    { id: 'vclass', name: 'Mercedes-Benz V-Class', cat: 'Executive', tabs: ['executive', 'group'], price: '$220', seats: 6, trans: 'Automatic', drive: 'Chauffeur opt.', badge: 'VIP groups', gradient: 'linear-gradient(135deg,#1F1E1E,#4A4746)', img: 'assets/images/vehicles/mercedes-v-class.jpg', alt: 'Silver Mercedes-Benz V-Class luxury van' }
  ];
  var TABS = [
  ...
  function carCard(c) {
    var media = c.img
      ? '<img src="' + c.img + '" alt="' + esc(c.alt || c.name) + '" loading="lazy" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;">'
      : '<span style="position:absolute;bottom:12px;left:12px;font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.55);background:rgba(0,0,0,.28);padding:5px 9px;border-radius:6px;">' + esc(c.photo) + '</span>';
    var bg = c.img ? '#141313' : c.gradient;
    return '<div class="fleet-card" style="border:1px solid #ECEAE7;border-radius:24px;overflow:hidden;background:#fff;transition:all .35s cubic-bezier(.4,0,.2,1);">' +
      '<div style="position:relative;aspect-ratio:16/10;background:' + bg + ';overflow:hidden;">' + media +
